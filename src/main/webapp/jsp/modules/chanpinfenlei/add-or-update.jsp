		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑产品分类</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑产品分类</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">产品分类信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>产品分类</label>
										<input name="chanpinfenlei" id="chanpinfenlei" name="chanpinfenlei" class="form-control" placeholder="产品分类">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chanpinfenlei/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("chanpinfenlei/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("chanpinfenlei/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chanpinfenlei/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#chanpinfenlei").val(ruleForm.chanpinfenlei);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chanpinfenlei != null && res.data.chanpinfenlei != ''){
						...
						$("#chanpinfenlei").val(res.data.chanpinfenlei);
						$("#chanpinfenlei").attr('readonly','readonly');
					}
				}
			});  
            }
