...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>产品信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="chanpinpinpaiSearch" class="form-control form-control-sm" placeholder="请输入产品品牌" aria-controls="tableId">
									<label>
										规格
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chanpinfenlei')">产品分类<i id="chanpinfenleiIcon" class="fa fa-sort"></i></th>
											<th>产品封面</th>
											<th onclick="sort('chanpinpinpai')">产品品牌<i id="chanpinpinpaiIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('chengfenbiao')">成分表<i id="chengfenbiaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('chanpinjiage')">产品价格<i id="chanpinjiageIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('zhuyaogongxiao')">主要功效<i id="zhuyaogongxiaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shengchangongsi')">生产公司<i id="shengchangongsiIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			...
			if($('#chanpinpinpaiSearch').val() != null && $('#chanpinpinpaiSearch').val() != ''){
				searchForm.chanpinpinpai ="%" +  $('#chanpinpinpaiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("chanpinxinxi/page","GET",{
				...
				chanpinpinpai : searchForm.chanpinpinpai,	
		...
		function setDataRow(item,number){
			...
			var chanpinfenleiCell  = document.createElement('td');

						  chanpinfenleiCell.innerHTML = item.chanpinfenlei; 

			row.appendChild(chanpinfenleiCell);
			var chanpinfengmianCell  = document.createElement('td');

				                var chanpinfengmianImg = document.createElement('img');
			chanpinfengmianImg.setAttribute('src',baseUrl+item.chanpinfengmian);
			chanpinfengmianImg.setAttribute('height',100);
			chanpinfengmianImg.setAttribute('width',100);
			chanpinfengmianCell.appendChild(chanpinfengmianImg);


			row.appendChild(chanpinfengmianCell);
			var chanpinpinpaiCell  = document.createElement('td');

						 chanpinpinpaiCell.innerHTML = item.chanpinpinpai;

			row.appendChild(chanpinpinpaiCell);
			...
			var chengfenbiaoCell  = document.createElement('td');

						 chengfenbiaoCell.innerHTML = item.chengfenbiao;

			row.appendChild(chengfenbiaoCell);
			var chanpinjiageCell  = document.createElement('td');

						 chanpinjiageCell.innerHTML = item.chanpinjiage;

			row.appendChild(chanpinjiageCell);
			var zhuyaogongxiaoCell  = document.createElement('td');

						 zhuyaogongxiaoCell.innerHTML = item.zhuyaogongxiao;

			row.appendChild(zhuyaogongxiaoCell);
			var shengchangongsiCell  = document.createElement('td');

						 shengchangongsiCell.innerHTML = item.shengchangongsi;

			row.appendChild(shengchangongsiCell);
			var chanpinxiangqingCell  = document.createElement('td');
