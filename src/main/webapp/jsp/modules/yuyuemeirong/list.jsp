...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">预约美容管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>预约美容列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">预约美容列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="xiangmubumenSearch" class="form-control form-control-sm" placeholder="请输入项目部门" aria-controls="tableId">
									<label>
										用户姓名
									</label>
	...
	<script>
		...
		function search(){
			...
			if($('#xiangmubumenSearch').val() != null && $('#xiangmubumenSearch').val() != ''){
				searchForm.xiangmubumen ="%" +  $('#xiangmubumenSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("yuyuemeirong/page","GET",{
				...
				xiangmubumen : searchForm.xiangmubumen,	
		...
		function sh(){
			...
			httpJson("yuyuemeirong/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yuyuemeirong/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"yuyuemeirong");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"yuyuemeirong");
