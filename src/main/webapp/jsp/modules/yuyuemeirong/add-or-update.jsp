		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑预约美容</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>预约美容管理</span></li>
								<li class="breadcrumb-item active"><span>编辑预约美容</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">预约美容信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>项目部门</label>
										<input name="xiangmubumen" id="xiangmubumen" name="xiangmubumen" class="form-control" placeholder="项目部门">
									</div>
									<div class="form-group col-md-6">
										<label>项目类型</label>
										<input name="xiangmuleixing" id="xiangmuleixing" name="xiangmuleixing" class="form-control" placeholder="项目类型">
									</div>
									<div class="form-group col-md-6">
										<label>产品名称</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yuyuemeirong/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yuyuemeirong/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yuyuemeirong/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yuyuemeirong/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#xiangmubumen").val(ruleForm.xiangmubumen);	
