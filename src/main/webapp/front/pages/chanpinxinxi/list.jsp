				...
				<div class="box" style='width:60%'>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							...
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(146, 180, 230, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="chanpinmingcheng" id="chanpinmingcheng" placeholder="产品名称" autocomplete="off" class="layui-input">
						</div>
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(146, 180, 230, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>产品品牌</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(146, 180, 230, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="chanpinpinpai" id="chanpinpinpai" placeholder="产品品牌" autocomplete="off" class="layui-input">
						</div>
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(146, 180, 230, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>规格</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(146, 180, 230, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="guige" id="guige" placeholder="规格" autocomplete="off" class="layui-input">
						</div>
		...
		<div v-if="1 == 1" style="position: absolute;left: 0;top: 0;transform: translate3d(-100%, 0, 0);" :style='{"padding":"0 20px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"140px","borderStyle":"solid","height":"auto"}'>
			...
			<div v-for="(item,index) in categoryList" :key="index" >
				<div style="text-align: center;cursor: pointer;box-sizing: border-box;" :style='swiperIndex==index?{"padding":"0 10px","boxShadow":"0 4px 0px #F7A0B0","margin":"10px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(144, 180, 230, 1)","color":"#fff","borderRadius":"10px 30px 30px 30px","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}:{"padding":"0 10px","boxShadow":"0 4px 0px #B1B1B1","margin":"10px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(246, 245, 245, 1)","color":"rgba(177, 177, 177, 1)","borderRadius":"10px 30px 30px 30px","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' :index="index" class="category-search">{{categoryList[index]}}</div>
							...
							<div @click="jump('../chanpinxinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="4=='3'?'list-item3':4=='5'?'list-item5':''">
								<div class="list-item-body animation-box" :style='{"padding":"0 10px 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(151, 178, 226, 1)","backgroundColor":"#fff","borderRadius":"30px","borderWidth":"4px","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(151, 178, 226, 1)","borderRadius":"0","borderWidth":"4px","width":"170px","borderStyle":"solid","height":"200px"}' :src="item.chanpinfengmian?baseurl+item.chanpinfengmian.split(',')[0]:''">
									<div class="info">
										...
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}' class="name">{{item.chanpinmingcheng}}</div>
									</div>
								</div>
							</div>
						</div>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				http.request('config/list', 'get', {
        			...
        			http.request(`option/chanpinfenlei/chanpinfenlei`,'get',{},(res)=>{
                			vue.chanpinfenleiOptions = res.data
        			});
				...
				//类型搜索
				  ...
				  // 获取列表数据
				  http.request('option/chanpinfenlei/chanpinfenlei', 'get', {}, function(res) {
				...
				if(vCategory!='' && category!='全部') {
			        ...
			        if (jquery('#chanpinpinpai').val()) {
			          param['chanpinpinpai'] = jquery('#chanpinpinpai').val() ? '%' + jquery('#chanpinpinpai').val() + '%' : '';
			        }
			        if (jquery('#guige').val()) {
