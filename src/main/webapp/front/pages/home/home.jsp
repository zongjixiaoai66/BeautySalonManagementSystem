...
<html>
	...
	<body>
		...
		<div id="app">
            ...
            <!-- 推荐 -->
				<!-- 样式一 -->
				<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220307/10033bce894b4454bc119a87dd3b0993.png) no-repeat top","borderStyle":"solid"}'>
				  <div class="box" style='width:60%'>
					<div v-if="true && 1 == 1" class="idea recommendIdea" :style='{"padding":"10px 5px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220307/b2e3ccc73e894b6199416a1a884ad5f1.png) no-repeat top","width":"100%","borderStyle":"solid","height":"auto"}'>
						<div class="box1"></div>
						<div class="box2"></div>
						<div class="box3"></div>
						<div class="box4"></div>
				    ...
				    <div class="title" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"-110px 0 80px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"rgba(255, 255, 255, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"20px","borderStyle":"solid"}'>
				      <span>Recommend</span><span>医美项目推荐</span>
				    </div>
				    ...
				    <div class="list">
				      <div v-for="(item,index) in yimeixiangmuRecommend" :key="index" @click="jump('../yimeixiangmu/detail.jsp?id='+item.id)" class="list-item" :class="5=='3'?'list-item3':5=='5'?'list-item5':''">
				        <div class="list-item-body animation-box" :style='{"padding":"6px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(151, 178, 226, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
							<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(255, 255, 255, 1)","borderRadius":"80px","borderWidth":"4px","width":"170px","borderStyle":"solid","height":"260px"}' :src="item.xiangmufengmian?baseurl+item.xiangmufengmian.split(',')[0]:''" alt="" />
							<div class="line1" v-if='true' :style='{"isshow":true,"padding":"0","margin":"10px 0","backgroundColor":"rgba(0, 0, 0, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0 0 6px 6px","textAlign":"center","fontSize":"14px"}' class="name">{{item.xiangmumingcheng}}</div>
				        </div>
				      </div>
				    </div>
				    <div class="clear"></div>
				    <div style="text-align: center;">
			    <button @click="jump('../yimeixiangmu/list.jsp')" style="display: block;cursor: pointer;" type="button" :style='{"padding":"0 25px","boxShadow":"0 4px 0px #F7A0B0","margin":"4px auto","borderColor":"#ccc","backgroundColor":"rgba(144, 180, 230, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"10px 30px 30px 30px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"54px"}'>查看更多<i v-if="false" :style='{"isshow":false,"padding":"0 0 0 1px","fontSize":"14px","color":"rgba(110,22,64,1)"}' class="layui-icon layui-icon-next"></i></el-button>
				    </div>
            ...
            <!-- 推荐 -->
				...
				<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220307/10033bce894b4454bc119a87dd3b0993.png) no-repeat top","borderStyle":"solid"}'>
				  <div class="box" style='width:60%'>
				    ...
				    <div class="title" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"-110px 0 80px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"rgba(255, 255, 255, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"20px","borderStyle":"solid"}'>
				      <span>Recommend</span><span>美容项目推荐</span>
				    </div>
					<div v-if="true && 1 == 2" class="idea recommendIdea" :style='{"padding":"10px 5px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220307/b2e3ccc73e894b6199416a1a884ad5f1.png) no-repeat top","width":"100%","borderStyle":"solid","height":"auto"}'>
						<div class="box1"></div>
						<div class="box2"></div>
				    ...
				    <div class="list">
				      <div v-for="(item,index) in meirongxiangmuRecommend" :key="index" @click="jump('../meirongxiangmu/detail.jsp?id='+item.id)" class="list-item" :class="5=='3'?'list-item3':5=='5'?'list-item5':''">
				        <div class="list-item-body animation-box" :style='{"padding":"6px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(151, 178, 226, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
							<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(255, 255, 255, 1)","borderRadius":"80px","borderWidth":"4px","width":"170px","borderStyle":"solid","height":"260px"}' :src="item.xiangmufengmian?baseurl+item.xiangmufengmian.split(',')[0]:''" alt="" />
							<div class="line1" v-if='true' :style='{"isshow":true,"padding":"0","margin":"10px 0","backgroundColor":"rgba(0, 0, 0, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0 0 6px 6px","textAlign":"center","fontSize":"14px"}' class="name">{{item.xiangmumingcheng}}</div>
				        </div>
				    ...
				    <div class="clear"></div>
				    <div style="text-align: center;">
			    <button @click="jump('../meirongxiangmu/list.jsp')" style="display: block;cursor: pointer;" type="button" :style='{"padding":"0 25px","boxShadow":"0 4px 0px #F7A0B0","margin":"4px auto","borderColor":"#ccc","backgroundColor":"rgba(144, 180, 230, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"10px 30px 30px 30px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"54px"}'>查看更多<i v-if="false" :style='{"isshow":false,"padding":"0 0 0 1px","fontSize":"14px","color":"rgba(110,22,64,1)"}' class="layui-icon layui-icon-next"></i></el-button>
				    </div>
					<div v-if="true && 1 == 3" class="idea recommendIdea" :style='{"padding":"10px 5px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220307/b2e3ccc73e894b6199416a1a884ad5f1.png) no-repeat top","width":"100%","borderStyle":"solid","height":"auto"}'>
						<div class="box1"></div>
						<div class="box2"></div>
				...
				<div class="recommend index-pv3" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220307/09be19b42e9c41d38afe12ef1d897f86.png) no-repeat top","borderStyle":"solid"}'>
					<div class="box" style='width:80%'>
						...
						<div class="title" :style='{"isshow":true,"padding":"0 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 140px","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"rgba(147, 181, 230, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"20px","borderStyle":"solid"}'>
							<span>DATA SHOW</span><span>产品信息展示</span>
						</div>
					...
					<div class="list-4">
					    <div class="list-4-body-left" style="display: flex;flex-direction: column;transform: none !important">
							<div class="list-4-body" style="display: flex;flex-direction: row;">
										<div v-if="chanpinxinxiList.length>0" @click="jump('../chanpinxinxi/detail.jsp?id='+chanpinxinxiList[0].id)" class="list-4-item animation-box item-1" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"322px","borderStyle":"solid","height":"205px"}'>
										  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="chanpinxinxiList[0].chanpinfengmian?baseurl+chanpinxinxiList[0].chanpinfengmian.split(',')[0]:''" alt="" />
										  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="false" class="list-4-item-center">
											<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{chanpinxinxiList[0].chanpinmingcheng}}</div>
										  </div>
										</div>
										<div v-if="chanpinxinxiList.length>1" @click="jump('../chanpinxinxi/detail.jsp?id='+chanpinxinxiList[1].id)" class="list-4-item animation-box item-2" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"322px","borderStyle":"solid","height":"205px"}'>
										  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="chanpinxinxiList[1].chanpinfengmian?baseurl+chanpinxinxiList[1].chanpinfengmian.split(',')[0]:''" alt="" />
										  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="false" class="list-4-item-center">
											<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{chanpinxinxiList[1].chanpinmingcheng}}</div>
										  </div>
										</div>
							</div>
							<div v-if="chanpinxinxiList.length>2" @click="jump('../chanpinxinxi/detail.jsp?id='+chanpinxinxiList[2].id)" class="list-4-item animation-box item-3" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"664px","borderStyle":"solid","height":"353px"}'>
							  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="chanpinxinxiList[2].chanpinfengmian?baseurl+chanpinxinxiList[2].chanpinfengmian.split(',')[0]:''" alt="" />
							  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="false" class="list-4-item-center">
								<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{chanpinxinxiList[2].chanpinmingcheng}}</div>
							  </div>
							</div>
						</div>
					    <div class="list-4-body">
					    			<div v-if="chanpinxinxiList.length>3" @click="jump('../chanpinxinxi/detail.jsp?id='+chanpinxinxiList[3].id)" class="list-4-item animation-box item-4" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"322px","borderStyle":"solid","height":"353px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="chanpinxinxiList[3].chanpinfengmian?baseurl+chanpinxinxiList[3].chanpinfengmian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="false" class="list-4-item-center">
					    			  	<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{chanpinxinxiList[3].chanpinmingcheng}}</div>
					    			  </div>
					    			</div>
					    			<div v-if="chanpinxinxiList.length>4" @click="jump('../chanpinxinxi/detail.jsp?id='+chanpinxinxiList[4].id)" class="list-4-item animation-box item-5" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"0","borderWidth":"0","width":"322px","borderStyle":"solid","height":"205px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="chanpinxinxiList[4].chanpinfengmian?baseurl+chanpinxinxiList[4].chanpinfengmian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="false" class="list-4-item-center">
					    			  	<div  class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{chanpinxinxiList[4].chanpinmingcheng}}</div>
					    			  </div>
					    			</div>
					    </div>
					</div>
					<div class="clear"></div>
					<div style="text-align: center;">
					<button @click="jump('../chanpinxinxi/list.jsp')" style="display: block;cursor: pointer;" type="button" :style='{"padding":"0 25px","boxShadow":"0 4px 0px #F7A0B0","margin":"4px auto","borderColor":"#ccc","backgroundColor":"rgba(144, 180, 230, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"10px 30px 30px 30px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"54px"}'>查看更多<i v-if="false" :style='{"isshow":false,"padding":"0 0 0 1px","fontSize":"14px","color":"rgba(110,22,64,1)"}' class="layui-icon layui-icon-next"></i></el-button>
					</div>
		...
		<script>
			var vue = new Vue({
				...
				data: {
                    ...
                    // 推荐数据
					yimeixiangmuRecommend: [],
                    // 推荐数据
					meirongxiangmuRecommend: [],
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
                ...
                // 获取推荐信息
      				var autoSortUrl = "yimeixiangmu/autoSort";
				http.request(autoSortUrl, 'get', {
					page: 1,
					limit: 5 * 2 
				}, function(res) {
					vue.yimeixiangmuRecommend = res.data.list
					let flag = 1;
					let options = {"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"slidesPerView":5,"loop":true,"spaceBetween":20,"autoplay":{"delay":3000,"disableOnInteraction":false}}
					options.pagination = {el:'null'}
					...
					if(flag == 3) {
						vue.$nextTick(() => {
								new Swiper ('#recommendyimeixiangmu', options)
								new Swiper ('#recommendmeirongxiangmu', options)
						})
					}
					...
					if(flag == 5) {
						vue.$nextTick(() => {
							var swiper = new Swiper('#recommend-five-swiperyimeixiangmu', {
								loop: true,
								speed: 500,
                ...
                // 获取推荐信息
      				var autoSortUrl = "meirongxiangmu/autoSort";
				http.request(autoSortUrl, 'get', {
					page: 1,
					limit: 5 * 2 
				}, function(res) {
					vue.meirongxiangmuRecommend = res.data.list
					let flag = 1;
					let options = {"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"slidesPerView":5,"loop":true,"spaceBetween":20,"autoplay":{"delay":3000,"disableOnInteraction":false}}
					options.pagination = {el:'null'}
					...
					if(flag == 5) {
						vue.$nextTick(() => {
							var swiper = new Swiper('#recommend-five-swipermeirongxiangmu', {
								loop: true,
								speed: 500,
								slidesPerView: Number(5),
								spaceBetween: Number(10),
