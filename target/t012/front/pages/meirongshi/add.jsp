				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.meirongshigonghao" type="text" :readonly="ro.meirongshigonghao" name="meirongshigonghao" id="meirongshigonghao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zhiyenianxian" type="text" :readonly="ro.zhiyenianxian" name="zhiyenianxian" id="zhiyenianxian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">专长介绍：</label>
						<div class="layui-input-block">
							<textarea name="zhuanzhangjieshao" id="zhuanzhangjieshao">请输入专长介绍</textarea>
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='zhiyenianxian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.zhiyenianxian = true;
                                                continue;
                                        }
                                        if(o=='zhuanzhangjieshao'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.zhuanzhangjieshao = true;
                                                continue;
                                        }
					}
				}
				...
				form.on('submit(*)', function(data) {
					...
					var zhuanzhangjieshao = tinymce.get('#zhuanzhangjieshao').getContent()
					data.zhuanzhangjieshao = zhuanzhangjieshao;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('meirongshi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('meirongshi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
