		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑预约医美</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>预约医美管理</span></li>
								<li class="breadcrumb-item active"><span>编辑预约医美</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">预约医美信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>医生账号</label>
										<input name="yishengzhanghao" id="yishengzhanghao" name="yishengzhanghao" class="form-control" placeholder="医生账号">
									</div>
									<div class="form-group col-md-6">
										<label>医生姓名</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yuyueyimei/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yuyueyimei/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yuyueyimei/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yuyueyimei/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
