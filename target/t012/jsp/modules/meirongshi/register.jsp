	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">美容师工号</label> 
							<input  name="meirongshigonghao" placeholder="美容师工号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">美容师姓名</label> 
							<input  name="meirongshixingming" placeholder="美容师姓名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">执业年限</label> 
							<input  name="zhiyenianxian" placeholder="执业年限" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "meirongshi/register";
				$.ajax({ 
					type: "POST",
					url: url,
